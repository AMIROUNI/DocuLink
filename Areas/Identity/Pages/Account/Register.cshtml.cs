    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.IsDoctor && Input.DiplomaFile != null)
                {
                    ...
                    var uniqueFileName = Guid.NewGuid().ToString() + "_" + Input.DiplomaFile.FileName;
                    var filePath = Path.Combine(uploadsFolder, uniqueFileName);

                    using (var fileStream = new FileStream(filePath, FileMode.Create))
                    {
                        await Input.DiplomaFile.CopyToAsync(fileStream);
                    }
                ...
                var user = new User
                {
                    ...
                    Specialty = Input.IsDoctor ? Input.Specialty : null,
                    Location = Input.IsDoctor ? Input.Location : null,
                ...
                if (result.Succeeded)
                {
                    ...
                    // Assign role based on IsDoctor
                    var role = Input.IsDoctor ? "Doctor" : "Patient";
