...
namespace DocuLink.Controllers
{
    public class MedicationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dosage,Form,Price")] Medication medication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Dosage,Form,Price")] Medication medication)
        {
            if (id != medication.Id)
            {
                return NotFound();
